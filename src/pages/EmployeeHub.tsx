    ...
    <div className="p-8 space-y-8 animate-in fade-in duration-500 bg-brand-bg h-full overflow-auto">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          <Button variant="outline" className="glass border-brand-border text-brand-text h-11 transition-all hover:bg-white font-bold px-6 shadow-sm">
            Payroll Report
          </Button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-8">
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="relative">
                    <Avatar className="h-16 w-16 border-2 border-white ring-2 ring-brand-bg transition-transform group-hover:scale-105 duration-300">
                  ...
                  <Button variant="ghost" size="icon" className="h-8 w-8 text-brand-muted hover:text-brand-blue hover:bg-brand-bg rounded-full">
                    <MoreHorizontal size={18} />
                  </Button>
                </div>
                
                <div className="space-y-1 mb-6">
                  <h3 className="font-extrabold text-lg text-brand-text leading-tight">{member.name}</h3>
                ...
                <div className="flex items-center gap-2">
                  <Button size="sm" variant="outline" className="flex-1 h-9 rounded-xl border-brand-border text-xs font-bold hover:bg-brand-bg gap-2">
                    <Mail size={14} className="text-brand-muted" /> Message
                  </Button>
                  <Button size="sm" variant="outline" className="flex-1 h-9 rounded-xl border-brand-border text-xs font-bold hover:bg-brand-bg">
                    Profile
                  </Button>
                </div>
              </div>
        ...
        <Card className="border-2 border-dashed border-brand-border bg-brand-bg/50 flex flex-col items-center justify-center p-8 gap-4 group cursor-pointer hover:bg-white hover:border-brand-blue/30 transition-all">
...
// Placeholder motion if framer-motion is not fully loaded in this snippet
const motion = {
