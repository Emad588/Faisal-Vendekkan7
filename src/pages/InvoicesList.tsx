                  ...
                  <div className="flex items-center justify-end gap-2">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="bg-white border-brand-border text-brand-text">
                        <DropdownMenuItem className="font-bold text-xs">View Parameters</DropdownMenuItem>
                        <DropdownMenuItem className="font-bold text-xs">Edit Structure</DropdownMenuItem>
                        <DropdownMenuItem className="font-bold text-xs text-emerald-600">Finalize Payment</DropdownMenuItem>
                        <DropdownMenuItem className="text-rose-500 font-bold text-xs">Void Transaction</DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
                  </div>
                </TableCell>
